        ...
        <>
            <div className={`productItem ${props.itemView}`}>
                ...
                <div className="info">
                    ...
                    {
                        props?.item?.countInStock >= 1 ? <span className="text-success d-block">В наличии</span>
                            :
                    ...
                    <div className="d-flex">
                        {/* <span className="oldPrice">Рублей {props?.item?.oldPrice}</span> */}
                        <span className="netPrice text-danger ml-2">Рублей {props?.item?.price}</span>
                    </div>
