                    ...
                    <div className="row">
                        ...
                        <div className="col-md-7 pl-5 pr-5 part2">
                            ...
                            <ul className="list list-inline d-flex align-items-center">
                                ...
                                <li className="list-inline-item">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <span className="text-light cursor ml-2" onClick={gotoReviews}>{reviewsData?.length} Отзывов</span>
                                    </div>
                                </li>
                            ...
                            <div className="d-flex info mb-3">
                                {/* <span className="oldPrice">Руб: {productData?.oldPrice}</span> */}
                                <span className="netPrice text-danger ml-2">Руб: {productData?.price}</span>
                            </div>
                            ...
                            <p className="mt-3">ОПТОВАЯ ЗАКУПКА НАЧИНАЕТСЯ ОТ ЗАКАЗА НА 15.000 рублей:<br/> <br/>{productData?.description}
                            </p>
                            ...
                            <div className="d-flex align-items-center mt-3 actions_">
                                ...
                                <Button className="btn-blue btn-lg btn-big btn-round bg-red" onClick={() => addtoCart()}>
                                    <BsCartFill /> &nbsp;
                                    {
                                        context.addingInCart === true ? "adding..." : " Добавить в корзину"
                                    }
                    ...
                    <div className='card mt-5 p-5 detailsPageTabs'>
                        <div className='customTabs'>
                            ...
                            <li className='list-inline-item'>
                                    ...
                                    >Написать отзыв ({reviewsData?.length})</Button>
                                </li>
                                {/* <li className='list-inline-item'>
                                        ...
                                        <div className='col-md-8'>
                                            ...
                                            <form className='reviewForm' onSubmit={addReview}>
                                                ...
                                                <div className='form-group'>
                                                    <textarea className='form-control shadow' placeholder='Написать отзыв'
                                                ...
                                                <div className='form-group mb-0'>
                                                    <Button type='submit' className='btn-blue btn-lg btn-big btn-round'>
                                                        {isLoading === true ? <CircularProgress color="inherit" className="loader" /> : 'добавить отзыв'}
