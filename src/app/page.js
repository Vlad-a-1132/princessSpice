            ...
            <div className="col-md-9 productRow">
              <div className="d-flex align-items-center res-flex-column">
                <div className="info" style={{ width: "35%" }}>
                  <h3 className="mb-0 hd">Популярные продукты</h3>
                  <p className="text-light text-sml mb-0">Не пропустите актуальные предложения </p>
                </div>
              ...
              <div className="d-flex align-items-center mt-3">
                <div className="info w-75">
                  <h3 className="mb-0 hd">Новые специи</h3>
                  <p className="text-light text-sml mb-0">Оптовые цены при заказе от 15.000</p>
                </div>
              ...
              <div className="d-flex align-items-center mt-4">
                <div className="info">
                  <h3 className="mb-0 hd">ПРЕДЛАГАЕМЫЕ ПРОДУКТЫ</h3>
                  <p className="text-light text-sml mb-0">Не пропустите актуальные предложения</p>
                </div>
